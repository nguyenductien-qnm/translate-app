...
const findRootEnv = (searchPath: string) => {
  if (searchPath == "/") throw new Error(".env file doesn't exist.");
...
console.log("projectEnvPath:::::", projectEnvPath);
console.log("lambdasDirPath:::::", lambdasDirPath);
console.log("lambdaLayersDirPath:::::", lambdaLayersDirPath);
